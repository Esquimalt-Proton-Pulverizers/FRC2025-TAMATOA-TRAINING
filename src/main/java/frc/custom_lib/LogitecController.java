 ...
 */
public class LogitecController extends GenericHID implements Sendable {
  /** Represents a digital button on a Logitech Controller using XInput mode. */
  public enum Button {
    /** A button. */
    kA(1),
    /** B button. */
  ...
  /** Represents an axis on a Logitech Controller using XInput mode. */
  public enum Axis {
    /** Left stick X axis. */
    kLeftX(0),
    /** Left stick Y axis. */
    kLeftY(1),
    /** Left trigger. */
    kLeftTrigger(2), // Note: Triggers share axis 2 with right; use 0–1 range
    /** Right trigger. */
    kRightTrigger(3), // In XInput, triggers are often merged into one axis; may need adjustment
    /** Right stick X axis. */
    kRightX(4),
    /** Right stick Y axis. */
    kRightY(5);
   ...
   */
  public LogitecController(final int port) {
    super(port);
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.publishConstString("ControllerType", "Logitec");
